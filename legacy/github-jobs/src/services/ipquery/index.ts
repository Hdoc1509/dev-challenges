...
const IPQueryServiceError = new ServiceError("CurrentLocation");

type ServiceResult = PromiseWithError<IPQueryResponse["location"]>;

export const getCurrentLocation = async (): ServiceResult => {
