...
**Challenge**: Create a reusable input with all the states in the design and a
...
- [x] User story (optional): Show input in a similar way like the design or use
      [Storybook](https://storybook.js.org/). Otherwise, showing the input in
